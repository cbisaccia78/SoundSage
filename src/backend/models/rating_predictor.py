...
def create_rating_model(tracks):
    ...
    feature_mean = feature_mean[nonzero_std_idx]
    feature_std = feature_std[nonzero_std_idx]
    ...
    analysis_mean = analysis_mean[nonzero_std_idx]
    analysis_std = analysis_std[nonzero_std_idx]
    ...
    track_audio_features_layer = keras.Input(shape=track_audio_features_train[0].shape)
    track_audio_analysis_layer = keras.Input(shape=track_audio_analysis_train[0].shape)
